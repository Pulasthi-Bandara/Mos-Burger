...
let orderList = [
  ...
  {
    customerId: 6,
    customerName: "Mahinda Ranasinghe",
    phoneNumber: "0763456789",
    address: "303 Temple Road, Jaffna",
    orderId: "P006",
    items: [
      {
        itemCode: "B1002",
...
export function deleteProductFromArray(index, category) {
...
//Customer Operations
export function setCustomer(newCustomer) {
  customerArray.push(newCustomer);
  saveCustomersToLocalStorage();
  console.log(customerArray);
}

export function deleteCustomerFromArray(index) {
...
function loadCustomersFromLocalStorage() {
  const storedProducts = localStorage.getItem("customerList");
  if (storedProducts) {
    customerArray = JSON.parse(storedProducts);
  }
}
...
export function deleteOrderFromArray(index) {
...
function loadOrdersFromLocalStorage() {
  const storedProducts = localStorage.getItem("orderList");
  if (storedProducts) {
